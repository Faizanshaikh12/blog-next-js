...
const Tabs = ({categories, handleOnSearch}: IPropType) => {
    ...
    return (
        <div className="my-6 flex justify-between items-center border-b-2 border-gray-100">
            <ul className="flex items-center">
                <li className={"mr-6 pb-6 border-b-4 rounded-sm cursor-pointer" + `${
                    router.pathname === '/'
                ...
                {categories.map(category => {
                    return (
                        <li
                            className={"mr-6 pb-6 border-b-4 rounded-sm cursor-pointer" + `${
